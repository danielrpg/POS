	...
	*/
	...
	function do_excel_import()
	{
		...
		else
		{
			...
			{
				echo json_encode( array('success'=>false,'message'=>'El archivo que cargaste no tiene informacion o no esta en un formato soportado.') );
				return;
			}
		}
		...
		{
			$msg = "Varios clientes importados. algunos no, esta es la lista y sus CODIGOS (" .count($failCodes) ."): ".implode(", ", $failCodes);
			$success = false;
		}
		else
		{
			$msg = "Importación de Clientes Exitosa";
		}
