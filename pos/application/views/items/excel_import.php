...
?>
<div id="required_fields_message">Importar registros desde hoja de excel</div>
<ul id="error_message_box"></ul>
<b><a href="<?php echo site_url('items/excel'); ?>">Descargar plantilla de excel importada (CSV)</a></b>
