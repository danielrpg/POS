...
<head>
	...
	<title><?php echo $this->config->item('company').' -- '.$this->lang->line('common_powered_by').' Prisma Punto de Venta' ?></title>
...
<div id="menubar" class='navbar navbar-inverse navbar-fixed-top'>
  <dic class='container'>
	<div id="menubar_container" class='navbar-header'>
		<div id="menubar_company_info">
		<span id="company_title"><?php echo $this->config->item('company'); ?></span><br />
		<span style='font-size:8pt;'><?php echo $this->lang->line('common_powered_by').' Ventas Sales'; ?></span>
	</div>
